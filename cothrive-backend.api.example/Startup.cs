...
using cothrive_backend.api.example.Auth0;
using cothrive_backend.api.example.Domain.Entities;
using cothrive_backend.api.example.Helpers;
using MediatR;
...
namespace cothrive_backend.api.example
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1.0.0-beta",
                    Title = "Capstone Example API",
                    Description = "Capstone Example API",
                    Contact = new OpenApiContact
                    {
                        Name = "Capstone Developers",
                        Email = "developers@Capstone.xyz",
                        Url = new Uri("https://www.Capstone.tech")
                    },
                    License = new OpenApiLicense
                    {
                        Name = "Use under permission of Capstone"
                    }
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint(swaggerString, "Capstone Authentication API v1");
                c.DocumentTitle = "Capstone Authentication API Docs";
